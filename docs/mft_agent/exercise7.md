...
To add a date directory to the output path.

### Summary

To add a directory with the schedule date as the directory name to the destination endpoint path when transferin the file, MFT_File_07.txt
